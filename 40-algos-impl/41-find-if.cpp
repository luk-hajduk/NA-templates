...
TEST_CASE("successful find_if", "[algorithm]")
{
    ...
    CHECK(training::find_if(data.begin(), data.end(), [](auto && elem){ return elem == 4; }) == data.begin() + 3);//tu jest uzyte wyrazenie lambda[]-tu sie zaczyna , ()-argumenty {}-to jak dziala i co zwraca 
